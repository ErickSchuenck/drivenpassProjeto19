...
export function registerWifi(title, userName, password, userId) {
    return __awaiter(this, void 0, void 0, function () {
        var encryptedPassword;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, checkForWifiUniqueness(userId, title)];
                case 1:
                    _a.sent();
...
function checkForWifiUniqueness(userId, title) {
    return __awaiter(this, void 0, void 0, function () {
        var wifi;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, wifiRepository.findWifi(userId, title)];
                case 1:
                    wifi = _a.sent();
                    if (wifi) {
                        throw {
...
export function getWifiById(userId, wifiId) {
    return __awaiter(this, void 0, void 0, function () {
        var wifi, decryptedWifiPassword;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, wifiRepository.getWifiById(userId, wifiId)];
                case 1:
                    wifi = _a.sent();
                    if (!wifi) {
                        throw {
...
export function deleteWifiById(userId, wifiId) {
    return __awaiter(this, void 0, void 0, function () {
        var wifi;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, wifiRepository.deleteWifiById(wifiId)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
